...
class NetworkClient (Process):
    ...
    def __init__(self, port: int, my_ip: str, id: int, shard_id: int, node_num: int, addresses_list: list, client_from_bft: Callable, client_ready: mpValue, stop: mpValue, bft_running: mpValue = mpValue(c_bool, False), dynamic=True):
                ...
                try:
                    ...
                    if j == -1: # -1 means broadcast to nodes in the same shard
                        ...
                        for i in range(self.N):
                            ...
                            target_shard_id = i // self.node_num
                    ...
                    #print(f"problem objective when sending {j} ,  {str(o)[0:120]}")
